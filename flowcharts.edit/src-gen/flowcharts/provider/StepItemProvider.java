...
/**
 * This is the item provider adapter for a {@link flowcharts.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StepItemProvider extends AbstractActivityItemProvider {
	/**
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Step_next_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Step_next_feature", "_UI_Step_type"),
						FlowchartsPackage.Literals.STEP__NEXT, true, false, true, null, null, null));
	}
