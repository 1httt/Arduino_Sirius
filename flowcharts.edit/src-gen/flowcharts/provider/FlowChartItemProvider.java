...
/**
 * This is the item provider adapter for a {@link flowcharts.FlowChart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowChartItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FlowchartsPackage.Literals.FLOW_CHART__ACTIVITIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(FlowchartsPackage.Literals.FLOW_CHART__ACTIVITIES,
				FlowchartsFactory.eINSTANCE.createStep()));

		newChildDescriptors.add(createChildParameter(FlowchartsPackage.Literals.FLOW_CHART__ACTIVITIES,
				FlowchartsFactory.eINSTANCE.createFork()));

		newChildDescriptors.add(createChildParameter(FlowchartsPackage.Literals.FLOW_CHART__ACTIVITIES,
				FlowchartsFactory.eINSTANCE.createJoin()));
	}
