 ...
 * </p>
 * <ul>
 *   <li>{@link stateMachine.impl.TransitionImpl#getInput <em>Input</em>}</li>
 *   <li>{@link stateMachine.impl.TransitionImpl#getOutput <em>Output</em>}</li>
...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public void setOutput(String newOutput) {
		...
		output = newOutput;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachinePackage.TRANSITION__OUTPUT, oldOutput,
					output));
	}
