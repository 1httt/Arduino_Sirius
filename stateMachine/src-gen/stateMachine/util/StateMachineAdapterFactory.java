...
public class StateMachineAdapterFactory extends AdapterFactoryImpl {
	...
	protected StateMachineSwitch<Adapter> modelSwitch = new StateMachineSwitch<Adapter>() {
		...
		@Override
		public Adapter caseOpened(Opened object) {
			return createOpenedAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link stateMachine.FSM <em>FSM</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link stateMachine.Opened <em>Opened</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOpenedAdapter() {
		return null;
	}
